...
export default class CirclesLoader extends React.PureComponent {
  ...
  _animation = (i) => {
    Animated.sequence([
      Animated.timing(this.state.opacities[i], { toValue: 0.1, duration: 600, useNativeDriver: this.props.useNativeDriver}),
      Animated.timing(this.state.opacities[i], { toValue: 1, duration: 600, useNativeDriver: this.props.useNativeDriver}),
    ]).start(() => {
